...
<template>
    <div class="container">
        ...
        <div class="input-content">
            <textarea class="weui-textarea" @input="oninput" placeholder="这一刻的想法.." v-model="content"
                maxlength="70"></textarea>
            <div class="weui-textarea-counter">
                <span>{{textCount.value}}</span>/70
            </div>
        </div>
                ...
                <div class="weui-uploader">
                    <div class="weui-uploader__bd">
                        ...
                        <div class="weui-uploader__input-box">
                            <input id="uploaderInputPub" class="weui-uploader__input" type="file" accept="image/*"
                                multiple="multiple">
                        </div>
                    </div>
...
let uploadCount = ref(0)
let content = ref('')
let textCount = ref(0)
let picList = reactive([])

const oninput = () => {
    textCount.value = content.value.length
}
...
* 删除已上传的图片
*/
const deleteImg = (target, gallery) => {
